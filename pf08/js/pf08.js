    ...
    //----------------------------------------------------
        $('#main').fullpage({
            ...
            afterLoad: function(origin, destination, direction){
                ...
                destination.index==0 ? $('h1 img').attr({'src':'./img/logo_w.png'}) : $('h1 img').attr({'src':'./img/logo_b.png'});
                destination.index==0 ? $('header').css({color:'#fff',textShadow:'1px 0 2px #333'}) : $('header').css({color:'#333',textShadow:'none'})
            },
        });
        ...
        $('.map').on('click',function(){
            $('.map_tex').css({visibility:'visible'})
        });
        $('.map_tex>i').on('click',function(){
            $('.map_tex').css({visibility:'hidden'})
        });
